...
@php
    $isM = substr($cooperative->sexe, 0, 1) === 'M'
@endphp
...
@section('main')
    <form action="{{ route('cooperatives.update', $cooperative->id) }}" method="POST">
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Modifier cooperative</h5>
                ...
                <form class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <select id="inputState" class="form-select" name="filiere_id">
                            ...
                            <option {{$filiere->id == old('filiere_id', $cooperative->filiere_id ?? '') ? 'selected' : ''}} value={{$filiere->id}}>{{$filiere->nom}}</option>
                            @endforeach
                        </select>
